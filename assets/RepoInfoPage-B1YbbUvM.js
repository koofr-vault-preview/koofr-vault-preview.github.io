import{r,u as b,j as e,a as j}from"./DynamicThemeProvider-CxehgrR0.js";import{c as s,u as y,e as N}from"./emotion-css.esm-CiHGz3gB.js";import{f as k}from"./index-CrWxlqLP.js";import{B as x,L as w}from"./Button-Dt6jELX4.js";import{D as C}from"./DashboardError-CLU_oSDT.js";import{u as S,D as L}from"./DashboardLayout-Crp_arGD.js";import{D}from"./DashboardLoading-J-9EyJlQ.js";import{u as R}from"./DashboardNavbar-s8GXp9xa.js";import{u as M}from"./useDocumentTitle-D3L4F_h2.js";import{a as h,u as v,M as I,b as B,c as E,d as U,f as A,g,h as H}from"./mainWebAuthenticated-CnuyUC0b.js";import{C as z}from"./Checkbox-B60T99_6.js";import{A as P}from"./PasswordInput-2Y4-YwFF.js";import"./error-icon@2x-BzFHMFnI.js";import"./GitRevision-BJZb5Tzu.js";import"./index-C4JoeLWg.js";import"./Navbar-D0t0rxK0.js";import"./NavbarSticky-DuO2swp8.js";const T=r.memo(({repo:a})=>{var u;const i=b(),o=h(),[t,l]=r.useState(a.autoLock);let n=[{value:"NoLimit",label:"No time limit"},{value:"Inactive1Minute",label:"1 minute of inactivity"},{value:"Inactive5Mininutes",label:"5 minutes of inactivity"},{value:"Inactive10Minutes",label:"10 minutes of inactivity"},{value:"Inactive30Minutes",label:"30 minutes of inactivity"},{value:"Inactive1Hour",label:"1 hour of inactivity"},{value:"Inactive2Hours",label:"2 hours of inactivity"},{value:"Inactive4Hours",label:"4 hours of inactivity"}],d;((u=t.after)==null?void 0:u.type)==="Custom"&&(n.push({value:"Custom",label:`Custom (${t.after.seconds} seconds)`}),d=t.after.seconds);const p=c=>{l(c),o.reposSetAutoLock(a.id,c)};return e.jsxs("div",{children:[e.jsx("h2",{className:s`
          font-size: 28px;
          font-weight: normal;
          margin: 0 0 10px;
