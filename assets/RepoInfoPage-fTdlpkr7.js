import{r,u as g,j as e,a as C}from"./DynamicThemeProvider-MqskYVZg.js";import{c as a,u as R,e as S}from"./emotion-css.esm-D9bkNW-b.js";import{f as L}from"./format-a-hYJmZ8.js";import{B as x,L as D}from"./Button-D3442RQe.js";import{D as M}from"./DashboardError-CWMC7Px8.js";import{u as I,D as B}from"./DashboardLayout-lSAZdAAB.js";import{D as E}from"./DashboardLoading-B88-7_AC.js";import{u as U}from"./DashboardNavbar-Dan82nwN.js";import{u as A}from"./useDocumentTitle-D3L4F_h2.js";import{a as f,M as H,u as h,b as P,c as z,d as T,e as V,g as F,h as v}from"./mainWebAuthenticated-BLrysYK4.js";import{C as K}from"./Checkbox-5Dzeg3U_.js";import{A as $}from"./PasswordInput-Dah_QNxH.js";import"./error-icon@2x-BzFHMFnI.js";import"./GitRevision-Bq_cgbwC.js";import"./index-Cto6cTBp.js";import"./Navbar-D-Wj6WD0.js";import"./NavbarSticky-ClW7pS7A.js";const b=r.memo(({repo:o})=>{const i=g(),t=f(),[s,l]=r.useState(o.autoLock),n=[{value:"NoLimit",label:"No time limit"},{value:"Inactive1Minute",label:"1 minute of inactivity"},{value:"Inactive5Mininutes",label:"5 minutes of inactivity"},{value:"Inactive10Minutes",label:"10 minutes of inactivity"},{value:"Inactive30Minutes",label:"30 minutes of inactivity"},{value:"Inactive1Hour",label:"1 hour of inactivity"},{value:"Inactive2Hours",label:"2 hours of inactivity"},{value:"Inactive4Hours",label:"4 hours of inactivity"}];let c;s.after?.type==="Custom"&&(n.push({value:"Custom",label:`Custom (${s.after.seconds} seconds)`}),c=s.after.seconds);const u=p=>{l(p),t.reposSetAutoLock(o.id,p)};return e.jsxs("div",{children:[e.jsx("h2",{className:a`
          font-size: 28px;
          font-weight: normal;
          margin: 0 0 10px;
