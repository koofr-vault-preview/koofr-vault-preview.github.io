...
`,ue=R.withComponent(G),me=R.withComponent("a");function $(t,e){switch(t){case"inline":return w(e.colors.text,e.colors.text);case"primary":return S(e.colors.primary,e.colors.primary,e.colors.textInverse,e.colors.primaryHover,e.colors.primaryHover,e.colors.textInverse);case"primary-inline":return w(e.colors.primary,e.colors.primaryHover);case"destructive":return S(e.colors.destructive,e.colors.destructive,e.colors.textInverse,e.colors.destructiveHover,e.colors.destructiveHover,e.colors.textInverse);case"destructive-inline":return w(e.colors.destructive,e.colors.destructiveHover);case"disabled":return O(S(e.colors.disabled,e.colors.disabled,e.colors.textInverse,e.colors.disabled,e.colors.disabled,e.colors.textInverse),T`
          cursor: default;
        `);case"disabled-inline":return w(e.colors.disabled,e.colors.disabled);default:return S("transparent",e.colors.borderDarker,e.colors.text,"transparent",e.colors.text,e.colors.text)}}const ge=p.memo(({variant:t,className:e,...r})=>{const n=F();return _.jsx(R,{className:O($(t,n),e),...r})}),ye=p.memo(({variant:t,className:e,...r})=>{const n=F();return _.jsx(ue,{className:O($(t,n),e),...r})});export{ge as B,ye as L,S as a,ne as b,me as c,A as d,de as e,ae as f,R as g,C as n};
