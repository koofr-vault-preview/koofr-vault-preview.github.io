import{r as i,u as g,j as e,b as o,a as y,d as b,L as k}from"./DynamicThemeProvider-75e49737.js";import{D as B}from"./DashboardLayout-cf841367.js";import{N as L,u as z}from"./DashboardNavbar-6c475016.js";import{u as E}from"./useDocumentTitle-2cb3b118.js";import{M as T,b as $,c as V,d as H,e as q,f as A,g as C,h as K,a as v,T as j,u as G}from"./mainWebAuthenticated-667e00b8.js";import{B as p,n as w,b as I}from"./Button-36aa6271.js";import{R as O}from"./RepoConfigInfo-1181a2f9.js";import{u as U}from"./index-ea7fdfe9.js";import{P as W}from"./PasswordInput-a81aa9e0.js";import{D as Y}from"./DirPicker-d1d97eed.js";import"./GitRevision-637f12f6.js";import"./index-8d8dd14f.js";import"./Navbar-eb58d508.js";import"./NavbarSticky-a2949c3e.js";import"./range-f00ddf15.js";const _=i.memo(({created:a})=>{const r=g(),s=U(),[n,t]=i.useState(!1),l=i.useCallback(()=>{a!==void 0&&s(`/repos/${a.repoId}`)},[s,a]);return e.jsxs("div",{children:[e.jsx("h1",{className:o`
            font-size: 28px;
            font-weight: normal;
            margin: 0 0 20px;
          ...
          `}),e.jsx("div",{className:o`
            margin-bottom: 25px;
          `,onMouseDown:()=>t(!0),children:e.jsx(O,{config:a.config})}),e.jsx("div",{className:o`
            border-bottom: 1px solid ${r.colors.border};
            margin-bottom: 25px;
          `}),e.jsx(p,{type:"button",variant:n?"primary":"disabled",disabled:!n,onClick:l,children:"Continue"})]})}),J=i.memo(({breadcrumbs:a})=>{const r=i.useMemo(()=>a.map((s,n)=>({id:s.id,name:s.name,isClickable:!1,hasCaret:!1,isLast:n===a.length-1})),[a]);return e.jsx(L,{breadcrumbs:r})}),Q=i.memo(({dirPickerId:a,onClick:r,canSelect:s,select:n,cancel:t,createDirEnabled:l,createDir:d})=>{const m=y(),x=g();return e.jsxs(e.Fragment,{children:[e.jsx(T,{children:e.jsx($,{children:"Select a folder"})}),e.jsx(V,{className:o`
            padding-bottom: 0;
            overflow: hidden;
          `,children:e.jsx("div",{className:b(o`
              ...
              `,m?o`
                  ...
                  `:o`
                    height: 300px;
                  `),children:e.jsx(Y,{pickerId:a,onClick:r})})}),e.jsxs(H,{children:[e.jsx(q,{children:e.jsx(p,{type:"button",disabled:!l,onClick:d,children:"Create folder"})}),e.jsxs(A,{children:[e.jsx(C,{type:"button",onClick:t,children:"Cancel"}),e.jsx(C,{type:"button",variant:s?"primary":"disabled",disabled:!s,onClick:n,children:"Select"})]})]})]})}),X=i.memo(({dirPickerId:a,onClick:r,canSelect:s,select:n,cancel:t,createDirEnabled:l,createDir:d})=>e.jsx(K,{show:a!==void 0,onHide:t,children:a!==void 0?e.jsx(Q,{dirPickerId:a,onClick:r,canSelect:s,select:n,cancel:t,createDirEnabled:l,createDir:d}):e.jsx(e.Fragment,{})})),u=w.label`
            ...
            `,s?o`
              ...
              `,children:e.jsx(p,{type:"submit",variant:f?"primary":"disabled",disabled:!f,children:"Create"})}),l?null:e.jsx("div",{children:e.jsx(p,{type:"button",variant:"primary-inline",className:o`
                ...
                `,children:e.jsx(j,{as:"textarea",value:m,className:o`
                    ...
                    height: 250px;
                    font-size: 13px;
                  `,onChange:c=>x(c.currentTarget.value)})}),e.jsx(p,{type:"button",variant:"primary",onClick:()=>{t.repoCreateFillFromRcloneConfig(a,m)},children:"Fill"})]}):null]})}),e.jsx(X,{dirPickerId:r.locationDirPickerId,onClick:S,canSelect:r.locationDirPickerCanSelect,select:N,cancel:D,createDirEnabled:r.locationDirPickerCreateDirEnabled,createDir:F})]})}),oe=i.memo(()=>{const a=v(),r=i.useMemo(()=>a.repoCreateCreate(),[a]),[s]=G((t,l)=>t.repoCreateInfoSubscribe(r,l),t=>t.repoCreateInfoData,[]);i.useEffect(()=>()=>{a.repoCreateDestroy(r)},[a,r]);const n=z("Create a new Safe Box");return E("Create a new Safe Box"),e.jsx(B,{navbarHeader:n,children:(s==null?void 0:s.type)==="Form"?e.jsx(ee,{createId:r,form:s}):(s==null?void 0:s.type)==="Created"?e.jsx(_,{created:s}):e.jsx(k,{})})}),ge=i.memo(()=>e.jsx(oe,{}));export{ge as RepoCreatePage};
